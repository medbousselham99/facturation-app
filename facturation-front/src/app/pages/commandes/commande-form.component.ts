  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        <h2>{{ isEdit ? 'Modifier' : 'Nouvelle' }} Commande</h2>
      </div>
      <form [formGroup]="form" (ngSubmit)="onSubmit()" class="form">
        <div class="form-grid">
          <div class="form-group">
            <label>Numéro Commande</label>
            <input type="text" formControlName="numero_commande" class="form-control">
          </div>
          <div class="form-group">
            <label>Client</label>
          ...
          <div class="form-group">
            <label>Date</label>
            <input type="date" formControlName="date_commande" class="form-control">
          </div>
          <div class="form-group">
            <label>Statut</label>
...
export class CommandeFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.route.snapshot.params['id']) {
      ...
      this.service.getCommande(this.itemId).subscribe(data => {
  ...
  onSubmit(): void {
    ...
    const obs = this.isEdit
      ? this.service.updateCommande(this.itemId!, this.form.value)
      : this.service.createCommande(this.form.value);
    obs.subscribe(() => this.router.navigate(['/commandes']));
  }
}
